...
import { getProjects, addProject, updateProject, deleteProject } from '../../data/store';
            ...
            {filtered.map((project) => (
              ...
              >
                ...
                <div className="w-full sm:w-24 h-20 rounded-xl overflow-hidden bg-[#1a1a1a] shrink-0">
                  <img
                    src={project.coverImage || 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&q=80'}
                    alt={project.title}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          ...
          >
            ...
            <p className="text-sm text-[#A0A0A0] mb-6">
              ...
              <strong className="text-white">{deleteConfirm.title}</strong>? This action cannot be undone.
            </p>
